...
A full-stack web application for managing officer rank progression and promotions. Designed for law enforcement roleplay communities and command staff to track officer advancement through the ranks.
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/SlayerKingG/Command-Staff-Dashboard.git
   cd Command-Staff-Dashboard
   ```
...
Made with ❤️ for Law Enforcement Roleplay Communities
